Feature: Hotel Booking
  ...
  Given the user is on the hotel booking page
  When the user enters booking details "Utkarsh", "Garg", "", "9876543210", "Double Room", "2", "01/01/2025", "01/02/2025", "yes", "Good", "Gateway", "No email provided"
  And submits the booking form
 ...
 Scenario: Booking fails due to missing full name and phone number
  Given the user is on the hotel booking page
  When the user enters booking details "", "", "utkarshs@gmail.com", "", "Double Room", "2", "01/01/2025", "01/02/2025", "yes", "Good", "Gateway", "Missing name and phone"
  And submits the booking form
