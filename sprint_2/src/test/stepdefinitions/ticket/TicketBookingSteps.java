...
public class TicketBookingSteps {
    ...
    private TicketBookingPage bookingPage=new TicketBookingPage(driver);;
...
//        Assert.assertFalse(bookingPage.verifySuccessMessage(), "Form submitted with invalid phone!");
        
//        boolean phoneMsg = bookingPage.getPhoneErrorMessage();
        Assert.assertTrue(bookingPage.getPhoneErrorMessage(), "Phone error message not displayed.");
    }

    @Then("an error message should be shown for empty date field")
    public void error_message_for_empty_date() {
//        Assert.assertFalse(bookingPage.verifySuccessMessage(), "Form submitted with empty date!");
        
//        boolean error = bookingPage.getDateErrorMessage();
        Assert.assertTrue(bookingPage.getDateErrorMessage(), "Phone error message not displayed.");
    }
