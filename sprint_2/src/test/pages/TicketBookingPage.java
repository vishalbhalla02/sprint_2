...
public class TicketBookingPage {
    ...
    By phoneErrorMsg = By.id("phoneError");
    By dateErrorMsg = By.id("dateError");

    // Add these methods in the class

    public boolean getPhoneErrorMessage() {
    	return driver.findElement(phoneErrorMsg).isDisplayed();
    	
//    	try {
//    		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(5));
//    		wait.until(ExpectedConditions.visibilityOfElementLocated(phoneErrorMsg));
//    		return driver.findElement(phoneErrorMsg).isDisplayed();
//    		} 
//    	catch (Exception e) {
//    		return false;
//    		}
    ...
    public boolean getDateErrorMessage() {
