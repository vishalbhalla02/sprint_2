...
//    public boolean verifyBookingFailure() {
//        return !driver.findElement(output).isDisplayed(); // Or check validation message
//    }
//  
    public boolean getEmailValidationMessage() {
    	return driver.findElement(By.id("emailError")).isDisplayed();
    }
    
    public boolean getFirstNameValidationMessage() {
//        return getValidationMessage(firstName);
    	return driver.findElement(By.id("nameError")).isDisplayed();  
    }
//
    public boolean getPhoneValidationMessage() {
        return driver.findElement(By.id("phoneError")).isDisplayed();
    }
